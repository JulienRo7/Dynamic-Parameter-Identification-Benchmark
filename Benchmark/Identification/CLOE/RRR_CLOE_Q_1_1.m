function Error=RRR_CLOE_Q_1_1(val, I, Theta,data_struct, t_0, t_f, N, optionsCLOE)
...
for k=1:N
    ...
    if isempty(i)
        ...
        Y(3*k-2:3*k)=[data_struct.q1(i)+(data_struct.q1(j)-data_struct.q1(i))/(data_struct.t(j)-data_struct.t(i))*(t(k)-data_struct.t(i));
                      data_struct.q2(i)+(data_struct.q2(j)-data_struct.q2(i))/(data_struct.t(j)-data_struct.t(i))*(t(k)-data_struct.t(i));
                      data_struct.q3(i)+(data_struct.q3(j)-data_struct.q3(i))/(data_struct.t(j)-data_struct.t(i))*(t(k)-data_struct.t(i))];
    else
        % else the right value is taken
        Y(3*k-2:3*k)=[data_struct.q1(i);
                      data_struct.q2(i);
                      data_struct.q3(i)];
    end
...
%         
%         Ys(3*k-2:3*k)=[y_s(i,1)+(y_s(j,1)-y_s(i,1))/(t_s(j)-t_s(i))*(t(k)-t_s(i));
%                        y_s(i,2)+(y_s(j,2)-y_s(i,2))/(t_s(j)-t_s(i))*(t(k)-t_s(i));
%                        y_s(i,3)+(y_s(j,3)-y_s(i,3))/(t_s(j)-t_s(i))*(t(k)-t_s(i))];
%     else
%         % else the right value is taken
        Ys(3*k-2:3*k)=[y_s(4,k);
                       y_s(5,k);
                       y_s(6,k)];
%     end
