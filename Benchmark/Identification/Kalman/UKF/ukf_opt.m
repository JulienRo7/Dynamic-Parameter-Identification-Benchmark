function [x, P, K, inov, x_kkm1, P_kkm1, P_xy, P_yy] = ukf_opt(t_km1, t_k, x_km1, u_km1, P, y_k, Rv, Rn, alpha, beta, kappa, sigmaComputeMethod)
%#codegen

% UKF: Unscented Kalman Filter
% This code is inspired of www.anuncommonlab.com.
...
parfor sp = 1:Ns
    X_x_kkm1(:, sp) = propagate_RRR_Additive(t_km1, t_k, state(:,sp), u_km1, pNoise(:,sp));
    X = X_x_kkm1(:, sp); % This step is required by the parfor in matlab
    Y_kkm1(:, sp)   = X(4:6) + mNoise(:,sp);
end
