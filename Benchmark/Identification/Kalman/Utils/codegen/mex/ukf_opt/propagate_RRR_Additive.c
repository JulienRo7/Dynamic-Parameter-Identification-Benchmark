...
static emlrtRSInfo wc_emlrtRSI = { 6,  /* lineNo */
...
static emlrtRSInfo xc_emlrtRSI = { 8,  /* lineNo */
  "propagate_RRR_Additive",            /* fcnName */
  "/home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Kalman/Utils/propagate_RRR_Additive.m"/* pathName */
};

static emlrtRSInfo qd_emlrtRSI = { 20, /* lineNo */
  "RRR_dyn_CL",                        /* fcnName */
  "/home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Utilities/RRR_dyn_CL.m"/* pathName */
};

static emlrtRSInfo rd_emlrtRSI = { 21, /* lineNo */
  "RRR_dyn_CL",                        /* fcnName */
  "/home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Utilities/RRR_dyn_CL.m"/* pathName */
};

static emlrtRSInfo sd_emlrtRSI = { 22, /* lineNo */
  "RRR_dyn_CL",                        /* fcnName */
  "/home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Utilities/RRR_dyn_CL.m"/* pathName */
};
...
static emlrtRSInfo wd_emlrtRSI = { 48, /* lineNo */
  "lusolve",                           /* fcnName */
  "/opt/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/lusolve.m"/* pathName */
};

static emlrtRSInfo xd_emlrtRSI = { 251,/* lineNo */
  "lusolve",                           /* fcnName */
  "/opt/MATLAB/R2018a/toolbox/eml/eml/+coder/+internal/lusolve.m"/* pathName */
};
  ...
  int32_T q_km1_size[1], real_T x_data[], int32_T x_size[1])
{
  ...
  Theta_size_idx_0 = (y - i9) + 1;
  loop_ub = (y - i9) + 1;
  for (y = 0; y < loop_ub; y++) {
    Theta_data[y] = x_km1_data[(i9 + y) - 1];
  }
  ...
  for (i9 = 0; i9 < loop_ub; i9++) {
    tunableEnvironment[0].f1.data[i9] = u_km1_data[i9];
  }

  tunableEnvironment[1].f1.size[0] = Theta_size_idx_0;
  for (i9 = 0; i9 < Theta_size_idx_0; i9++) {
    tunableEnvironment[1].f1.data[i9] = Theta_data[i9];
  }

  for (i9 = 0; i9 < 2; i9++) {
    t0_tunableEnvironment[i9] = tunableEnvironment[i9];
  }
  ...
  y = b_y->size[0];
  if (!((y >= 1) && (y <= i9))) {
    emlrtDynamicBoundsCheckR2012b(y, 1, i9, &emlrtBCI, sp);
  }

  emxFree_real_T(sp, &unusedU0);
  for (i9 = 0; i9 < 6; i9++) {
    tmp_data[i9] = b_y->data[(y + b_y->size[0] * i9) - 1];
  }
  ...
  i9 = 6 + Theta_size_idx_0;
  if (i9 != q_km1_size[0]) {
    emlrtSizeEqCheck1DR2012b(i9, q_km1_size[0], &emlrtECI, sp);
  }

  x_size[0] = 6 + Theta_size_idx_0;
  loop_ub = 6 + Theta_size_idx_0;
  for (i9 = 0; i9 < loop_ub; i9++) {
    x_data[i9] = tmp_data[i9] + q_km1_data[i9];
  }
