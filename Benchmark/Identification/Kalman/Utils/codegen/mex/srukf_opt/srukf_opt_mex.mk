...
MAKEFILE = srukf_opt_mex.mk

include srukf_opt_mex.mki
...
SRC_FILES =  \
	...
	qrsolve.c \
	xgeqp3.c \
	_coder_srukf_opt_info.c \
	_coder_srukf_opt_api.c \
	_coder_srukf_opt_mex.c \
	srukf_opt_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = srukf_opt_mex
...
SYS_INCLUDE += -I "/home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Kalman/Utils/codegen/mex/srukf_opt"
...
%.$(OBJEXT) : /home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Kalman/Utils/codegen/mex/srukf_opt/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Kalman/Utils/codegen/mex/srukf_opt/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/quentin/Desktop/MatlabCommented05092018/Benchmark/Identification/Kalman/Utils/codegen/mex/srukf_opt/%.cu
	$(CC) $(CCFLAGS) "$<"
