...
MAKEFILE = observationMatrix_mex.mk

include observationMatrix_mex.mki
...
SRC_FILES =  \
	...
	observationMatrix_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = observationMatrix_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/observationMatrix"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/observationMatrix/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/observationMatrix/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/observationMatrix/%.cu
	$(CC) $(CCFLAGS) "$<"
