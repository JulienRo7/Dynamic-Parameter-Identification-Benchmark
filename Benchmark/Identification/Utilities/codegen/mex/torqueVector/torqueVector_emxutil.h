 ...
 *
 * torqueVector_emxutil.h
 *
 * Code generation for function 'torqueVector_emxutil'
 *
 */

#ifndef TORQUEVECTOR_EMXUTIL_H
#define TORQUEVECTOR_EMXUTIL_H
...
/* End of code generation (torqueVector_emxutil.h) */
