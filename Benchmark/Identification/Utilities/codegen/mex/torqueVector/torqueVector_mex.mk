...
MAKEFILE = torqueVector_mex.mk

include torqueVector_mex.mki
...
MEX_FILE_NAME_WO_EXT = torqueVector_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/torqueVector"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/torqueVector/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/torqueVector/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/torqueVector/%.cu
	$(CC) $(CCFLAGS) "$<"
